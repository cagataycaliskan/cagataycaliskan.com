...
const ProfileCard: React.FC<ProfileCardProps> = memo(({ translations }) => {
  return (
    ...
    >
      <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-2xl p-8 border-2 border-gray-300/40 dark:border-gray-600/40 shadow-lg hover:bg-white/95 dark:hover:bg-gray-900/95 hover:border-brand-primary/30 dark:hover:border-brand-primary/30 hover:scale-[1.02] transition-all duration-200 will-change-transform">
        <div className="text-center lg:text-left">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="bg-gradient-primary bg-clip-text text-transparent inline-block py-2">
              {translations?.personal?.fullName}
            </span>
          </h1>
          
          <div className="inline-block mb-6">
            <span className="px-4 py-2 bg-gradient-secondary text-white rounded-full text-lg font-semibold shadow-lg hover:shadow-xl hover:scale-105 hover:bg-gradient-blue transition-all duration-200 cursor-default">
          ...
          <div className="flex justify-center gap-4">
            <a
              ...
              className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 hover:scale-110 hover:shadow-lg transition-all duration-200 group focus:ring-2 focus:ring-brand-primary focus:ring-offset-2"
            >
              <svg width="24" height="24" viewBox="0 0 20 20" fill="currentColor" className="text-gray-700 dark:text-gray-300 group-hover:text-brand-primary transition-colors duration-200" aria-hidden="true">
