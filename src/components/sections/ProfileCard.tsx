...
const ProfileCard: React.FC<ProfileCardProps> = ({ translations }) => {
  return (
    <motion.div
    ...
    >
      <div className="bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-2xl p-8 border border-gray-200/20 dark:border-gray-700/20 hover:bg-white/80 dark:hover:bg-gray-900/80 hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
        <div className="text-center lg:text-left">
          ...
          <div className="flex justify-center gap-4">
            <a
              ...
              className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 hover:scale-110 hover:shadow-lg transition-all duration-200 group"
            >
              <svg width="24" height="24" viewBox="0 0 20 20" fill="currentColor" className="text-gray-700 dark:text-gray-300 group-hover:text-blue-600 transition-colors duration-200">
            ...
            <a
              ...
              className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 hover:scale-110 hover:shadow-lg transition-all duration-200 group"
            >
              <svg width="24" height="24" viewBox="0 0 16 16" fill="none" className="group-hover:scale-110 transition-transform duration-200">
            ...
            <a
              ...
              className="p-3 bg-gray-100 dark:bg-gray-800 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 hover:scale-110 hover:shadow-lg transition-all duration-200 group"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="#D14836" className="group-hover:scale-110 transition-transform duration-200">
